                ...
                if (findByName("mavenJava") == null) {
                    create<MavenPublication>("mavenJava") {
                        ...
                        pom {
                            ...
                            description.set("Tenant-agnostic medallion Spark job templates built on Spark Boot")
                            url.set("https://github.com/OpenProjectX/spark-lakehouse")
                            ...
                            scm {
                                url.set("https://github.com/OpenProjectX/spark-lakehouse")
                                connection.set("scm:git:https://github.com/OpenProjectX/spark-lakehouse.git")
                                developerConnection.set("scm:git:ssh://git@github.com:OpenProjectX/spark-lakehouse.git")
                            }
                        }
                    }
                }
